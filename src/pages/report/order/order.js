...
export default class Order extends Component {
  ...
  onExpressOrderChange(key, value) {
    ...
    this.props.dispatchReportOrderList({
    ...
    return (
      <View className='order'>
        <View className='page-section'>
          <View>
            <Picker mode='selector' range={this.state.addressSelector} rangeKey='addressDetail'
        ...
        <View className='page-section'>
          <View>
            <Picker mode='selector' range={this.state.schemeSelector} rangeKey='schemeDetail'
